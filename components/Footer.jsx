      ...
      <footer id="contact" className="footer-section" style={{ color: "#fff" }}>
        ...
        <div className="socials">
          <div className="handles">
            ...
            <div className="social-links">
              <Link href="https://www.instagram.com/tseccodetantra/" target="_blank">
                <svg
                  name="logo-instagram"
              ...
              <Link
                href="https://www.linkedin.com/company/tsec-codetantra/mycompany/"
                target="_blank"
              >
                <svg
                  name="logo-linkedin"
        ...
        <div className="contactUs">
          ...
          <div className="contactList">
            <Link href="mailto:tseccodetantra@gmail.com" target="_blank">
              tseccodetantra@gmail.com
            </Link>
          </div>
        </div>
      </footer>
